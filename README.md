...
| **helm-add-gwapi-route** | Add or modernize Gateway API *Route templates (HTTPRoute/GRPCRoute/TLSRoute/TCPRoute/UDPRoute) in a Helm chart. Auto-detects add vs update mode; applies current v1.5 best practices (named rules, typed filters, optional BackendTLSPolicy) |
